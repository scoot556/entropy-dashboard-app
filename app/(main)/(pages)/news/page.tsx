        ...
        <div className="flex-1 space-y-4">
            ...
            <div className="flex md:gap-2 md:flex-row lg:gap-2 w-full justify-center flex-col gap-4">
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 grid-cols-1">
                    ...
                    <Button onClick={() => handleCategoryFetch("technology")} variant="primary">Latest Technology News</Button>
                </div>
                <Button onClick={() => handleCategoryFetch("general")} variant="primary" className="">Reset</Button>
            </div>
            {news && news.length !== 0 ? (
